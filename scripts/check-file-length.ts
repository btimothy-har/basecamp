...
const GRANDFATHERED: Readonly<Record<string, number>> = {
	...
	"swarm/ts/agents/daemon/client.ts": 1173,
	"swarm/ts/agents/daemon/frames.ts": 352,
	"swarm/ts/agents/daemon/index.ts": 461,
	"swarm/ts/agents/daemon/reporter.ts": 394,
	"swarm/ts/agents/daemon/tools.ts": 990,
	"swarm/ts/agents/tests/daemon-client.test.ts": 434,
	"swarm/ts/agents/tests/daemon-reporter.test.ts": 583,
	"swarm/ts/agents/tests/daemon-tools.test.ts": 1873,
	"swarm/ts/agents/tests/daemon-workstream.test.ts": 385,
