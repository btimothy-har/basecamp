"""SQLAlchemy engine, session factory, and declarative base for pi_observer."""
...
from pi_observer.constants import OBSERVER_DB_URL as DB_URL
from pi_observer.constants import OBSERVER_DIR
from pi_observer.exceptions import DatabaseClosedError, DatabaseNotConfiguredError, UnsupportedDialectError
...
class Database:
    """SQLAlchemy engine and session factory for pi_observer.
    ...
    → ``OBSERVER_DB_URL`` env var → default ``~/.pi/observer/observer.db``.
    """
    ...
    def __init__(self) -> None:
        ...
        import pi_observer.data.schemas  # noqa: F401, PLC0415 -- register schemas with Base
    ...
    def _init_schema(self) -> None:
        ...
        run ``pi-observer db migrate`` explicitly.
        """
        from pi_observer.services.migrations import (  # noqa: PLC0415
            needs_migration,
            stamp,
        )
        ...
        if is_new:
            ...
            logger.warning("Database schema is outdated. Run 'pi-observer db migrate' to update.")
