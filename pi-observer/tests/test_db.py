"""Tests for pi_observer.db module."""

import pytest
from pi_observer.data.schemas import ProjectSchema
from pi_observer.exceptions import DatabaseNotConfiguredError
...
class TestDatabaseMissingUrl:
    ...
    def test_raises_if_url_missing(self, monkeypatch):
        ...
        monkeypatch.setattr("pi_observer.services.db.DB_URL", "")
