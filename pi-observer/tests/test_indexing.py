"""Tests for pi_observer.pipeline.indexing module."""

from datetime import UTC, datetime, timedelta
from unittest.mock import MagicMock, patch

import numpy as np
from pi_observer.constants import EMBEDDING_DIMENSIONS
from pi_observer.data.enums import SectionType
from pi_observer.data.schemas import (
    ArtifactSchema,
    ProjectSchema,
    TranscriptSchema,
)
from pi_observer.pipeline.indexing import SearchIndexer, _content_hash
...
class TestIndexPending:
    def test_indexes_extraction(self, db):
        ...
        with (
            patch("pi_observer.pipeline.indexing.chroma") as mock_chroma,
        ):
