...
from pi_observer.llm.agents import ExtractionResult
...
class TestTranscriptExtractor:
    @patch("pi_observer.pipeline.extraction.Artifact")
    @patch("pi_observer.pipeline.extraction.TranscriptEvent.get_for_transcript")
