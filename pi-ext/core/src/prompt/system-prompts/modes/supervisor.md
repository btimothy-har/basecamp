...
Default to delegation for non-trivial work. Use subagents for bounded investigation, code search, review, second opinions, and contained implementation. Keep ownership here in this session: user conversation, requirement clarification, task tracking, technical judgment, and final integration.
