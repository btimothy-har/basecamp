...
allowed-tools: Bash(gh pr comment *), Bash(gh pr review *), Bash(gh api *)
...
hooks:
  PreToolUse:
    - matcher: Bash
      hooks:
        - type: command
          command: "${CLAUDE_PLUGIN_ROOT}/scripts/allow-pr-comments.sh"
---
...
Use AskUserQuestion to confirm the user is ready and choose a publish mode:
