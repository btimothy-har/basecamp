---
name: python-backend
description: Build Python web APIs, database-backed applications, or backend services. Provides expert guidance on FastAPI, async SQLAlchemy, PostgreSQL, Alembic migrations, and backend performance patterns. Invoke when creating API endpoints, designing database models, optimizing queries, planning migrations, or architecting backend services.
---
