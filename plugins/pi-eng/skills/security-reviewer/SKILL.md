...
description: Focused security analysis of code changes. Invoke when reviewing PRs with authentication, authorization, user input handling, API endpoints, or data processing. Also use when explicitly asked to check for security vulnerabilities, injection risks, or credential exposure.
---
