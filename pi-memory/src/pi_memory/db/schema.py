...
class Job(Base):
    ...
    durable_memory_items: Mapped[list[DurableMemoryItem]] = relationship(back_populates="job")
    durable_memory_audit_events: Mapped[list[DurableMemoryAuditEvent]] = relationship(back_populates="job")
...
class Transcript(Base):
    ...
    durable_memory_items: Mapped[list[DurableMemoryItem]] = relationship(back_populates="transcript")
...
class ActivityUnit(Base):
    ...
    durable_memory_sources: Mapped[list[DurableMemorySource]] = relationship(back_populates="activity_unit")
...
class SessionInterpretationSnapshot(Base):
    ...
    projection_records: Mapped[list[MemoryProjectionRecord]] = relationship(back_populates="snapshot")
...
class SessionInterpretationQualityReport(Base):
    ...
    projection_records: Mapped[list[MemoryProjectionRecord]] = relationship(back_populates="quality_report")
...
class DurableMemoryItem(Base):
    ...
    session: Mapped[MemorySession] = relationship(back_populates="durable_memory_items")
    transcript: Mapped[Transcript | None] = relationship(back_populates="durable_memory_items")
    snapshot: Mapped[SessionInterpretationSnapshot] = relationship(back_populates="durable_memory_items")
    quality_report: Mapped[SessionInterpretationQualityReport] = relationship(back_populates="durable_memory_items")
    job: Mapped[Job | None] = relationship(back_populates="durable_memory_items")
    superseded_by: Mapped[DurableMemoryItem | None] = relationship(
        back_populates="superseded_items",
        remote_side=[id],
    )
    superseded_items: Mapped[list[DurableMemoryItem]] = relationship(back_populates="superseded_by")
    ...
    projection_records: Mapped[list[MemoryProjectionRecord]] = relationship(back_populates="durable_memory")
...
class DurableMemorySource(Base):
    ...
    memory: Mapped[DurableMemoryItem] = relationship(back_populates="sources")
    snapshot: Mapped[SessionInterpretationSnapshot] = relationship(back_populates="durable_memory_sources")
    quality_report: Mapped[SessionInterpretationQualityReport] = relationship(back_populates="durable_memory_sources")
    activity_unit: Mapped[ActivityUnit | None] = relationship(back_populates="durable_memory_sources")
...
class MemoryProjectionRecord(Base):
    ...
    snapshot: Mapped[SessionInterpretationSnapshot | None] = relationship(back_populates="projection_records")
    quality_report: Mapped[SessionInterpretationQualityReport | None] = relationship(
        back_populates="projection_records",
    )
    durable_memory: Mapped[DurableMemoryItem | None] = relationship(back_populates="projection_records")
...
class DurableMemoryAuditEvent(Base):
    ...
    memory: Mapped[DurableMemoryItem] = relationship(back_populates="audit_events")
    job: Mapped[Job | None] = relationship(back_populates="durable_memory_audit_events")
