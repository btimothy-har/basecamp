...
| Basecamp OMP extension | `omp/` | The source-checkout-backed, independently loadable Oh My Pi migration target: an OMP-native file-length reminder plus package-discovered general-purpose skills and workflow commands |
