...
For complex analysis or research, apply the `planning` skill and agree the design in plan mode before executing. The plan should cover:
...
For small questions, proceed directly, tracking steps with your todo list.
