...
description: "Warehouse modeling guidance for designing, building, or reviewing dbt models. Keywords: dbt, fact table, dimension, data warehouse, mart, schema."
---
...
{% if is_incremental() %}
    WHERE order_date >= DATE_SUB(COALESCE((SELECT MAX(order_date) FROM {{ this }}), DATE '2020-01-01'), INTERVAL 3 DAY)
{% endif %}
```
