...
- `skill://sql` for SQL queries and query performance
- `skill://python-development` for Python scripts
- `skill://marimo` for reactive notebooks
- `skill://data-warehousing` for dbt or warehouse model questions
