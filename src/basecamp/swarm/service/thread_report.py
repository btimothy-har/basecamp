...
async def handle_thread_report(*, frame: ThreadReportFrame, node_id: str, store: Store) -> None:
    """Persist a top-level session's raw thread, keyed by the connection's node.
