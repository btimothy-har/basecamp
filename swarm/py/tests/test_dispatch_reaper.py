...
async def test_disconnect_reaper_marks_live_run_failed_terminates_process_and_wakes_waiter(
    ...
    monkeypatch.setattr("basecamp.swarm.service.reaper.terminate_process_group_if_runner", record_terminate)
...
async def test_disconnect_reaper_cancel_prevents_reap(
    ...
    terminated: list[int | None] = []
    monkeypatch.setattr(
        "basecamp.swarm.service.reaper.terminate_process_group_if_runner",
