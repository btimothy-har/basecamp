...
Analyze to learn, not to implement.
...
If the findings imply code, configuration, documentation, or product changes, recommend switching to work mode (or explore mode first, for complex work) before implementation.
