...
Repo memory is written for the user, not for you. They did the work and cannot see your session, so a page carries what changes a decision — never your reconstruction of what they already know. After a catch-up, the reconstruction goes in the conversation.
